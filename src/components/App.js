...
const App = () => {
  ...
  return (
    <div id="main">
      ...
      <form>
        <label>Name</label>
        <input type="text" name="Name" data-testid = 'name' onChange={handleNameChange}  value={name} />
        <label>Email address</label>
        <input type="text" name="Email" data-testid = 'email' onChange={handleEmailChange}  value={email}/>
        <label >Gender</label>
        <select  data-testid = 'gender' onChange={handleGenderChange}  selected={gender}>
          <option value="male" selected>male</option>
          <option value="female" >female</option>
          <option value="other" >other</option>
        </select>
        <label>Phone Number</label>
        <input type="text" name="phone" data-testid = 'phoneNumber' onChange={handlePhoneNumberChange}  value={phoneNumber} />
        <label>Password</label>
        <input type="password" name="password" data-testid = 'password' onChange={handlePasswordChange}  value={password} />
        <button data-testid = 'submit' onClick={handleSubmit} >Submit button</button>
      </form>
      {error && <p>{error}</p>}
